...
first_name = "Ron "
is_hungry =  "pets in the store"
number_of_pets = 14
# IN WORDS:
p " #{first_name} has #{number_of_pets} #{is_hungry}"
...
p " there are #{healthy_snacks} healthy_snacks and #{junk_food_snacks} junk food snacks."
p "total there are #{healthy_snacks + junk_food_snacks} snacks options "
